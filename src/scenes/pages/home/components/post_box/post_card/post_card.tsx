...
export const PostCard = ({ index, imageSrc, imageBlob, type, videoBlob }: Imageprops) => {
  ...
  return (
    <Grid width="100%" height="70px" container justifyContent="space-between" alignItems="center">
      ...
      <Grid container item xs={11} justifyContent="space-between" alignItems="center">
        <PostCardFile imageSrc={imageSrc} imageBlob={imageBlob} type={type} videoBlob={videoBlob} />
